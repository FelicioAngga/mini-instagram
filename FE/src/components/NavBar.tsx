  ...
  return (
    <div className='py-2 px-4 fixed w-full max-w-md top-0 inset-x-0 mx-auto bg-[#FFF]'>
      <div onClick={changePass} className='cursor-pointer absolute flex gap-2 right-0'>
        ...
        <img className='object-cover w-12 h-12 rounded-full' src={image64 ? `data:image/png;base64,${image64}` : 'https://assets.pikiran-rakyat.com/crop/0x0:0x0/x/photo/2022/08/11/1722136995.jpg'} alt="" />
      </div>
